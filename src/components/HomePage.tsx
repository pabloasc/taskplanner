  ...
  return (
    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-semibold text-gray-900 dark:text-white">AI Task Planner</h1>
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Organize your plans with AI assistance</p>
      </div>
